...
function problemA () {
  ...
  // promise version
  promisifiedReadFile('poem-one/stanza-01.txt').then(function(fileContent){
    blue(fileContent);
  }).catch(function(err){
    console.error(err);
  })
...
function problemB () {
  ...
  // promise version
  promisifiedReadFile('poem-one/stanza-02.txt').then(function(fileContent1){
    blue(fileContent1);
...
function problemD () {
  ...
  // promise version
  // ???
   promisifiedReadFile('poem-one/stanza-04.txt').then(function(fileContent){
    blue(fileContent);
  }).catch(function(err){
    magenta(err);
  })
...
function problemE () {
  ...
  // promise version
  // ???
    promisifiedReadFile('poem-one/stanza-03.txt').then(function(fileContent1){
    blue(fileContent1);
